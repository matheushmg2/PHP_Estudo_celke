...
class AdmPaginacao{ // Quando instrâcio a classe "AdmPaginacao" -> Terei que passa o __contruct($Link)
    ...
    private function layoutPaginacao(){
        ...
        if($this->Pagina == 1) {
            ...
            cursor: default; opacity: 0.6; color: black;' href='".$this->Link. $this->Variavel ."' tabindex='-1'>Primeira</a>";
        } else {
            $this->Resultado .= "            <a class='page-link' href='".$this->Link.$this->Variavel ."' tabindex='-1'>Primeira</a>";
        }
        ...
        for($iPag = $this->Pagina - $this->MaxLinks; $iPag <= $this->Pagina - 1; $iPag++){
            if($iPag >= 1){
                $this->Resultado .= "        <li class='page-item'><a class='page-link' href='".$this->Link."/".$iPag.$this->Variavel."'>$iPag</a></li>";
            }
        ...
        for($dPag = $this->Pagina + 1; $dPag <= $this->Pagina + $this->MaxLinks; $dPag++){
            if($dPag  <= $this->TotalPaginas){
                $this->Resultado .= "        <li class='page-item'><a class='page-link' href='".$this->Link."/".$dPag.$this->Variavel."'>$dPag</a></li>";
            }
        }
        ...
        if($this->Pagina == $this->TotalPaginas){
            $this->Resultado .= "            <a class='page-link' style='pointer-events: none;
            cursor: default; opacity: 0.6; color: black;' href='".$this->Link."/".$this->TotalPaginas.$this->Variavel."'>Última</a>";
        } else {
            $this->Resultado .= "            <a class='page-link' href='".$this->Link."/".$this->TotalPaginas.$this->Variavel."'>Última</a>";
        }
