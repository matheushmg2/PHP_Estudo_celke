...
<div class="content p-1">
    <div class="list-group-item">
        <div class="d-flex">
            ...
            <?php
            if ($this->Dados['botao']['ListarTipoPagina']) {
                ?>
                <div class="p-2">
                <a href="<?php echo URLADM . 'TipoPagina/listar'; ?>" class="btn btn-outline-info btn-sm">Listar</a>
            </div>
                <?php
            }
            ?>
        ...
        <form method="POST" action="" enctype="multipart/form-data"> 
            ...
            <input name="CadastrarTipoPagina" type="submit" class="btn btn-warning" value="Salvar">
        </form>
    </div>
</div>
