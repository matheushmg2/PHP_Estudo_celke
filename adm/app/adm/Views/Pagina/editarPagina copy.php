    ...
    <div class="list-group-item">
        <div class="d-flex">
            ...
            if ($this->Dados['botao']['VisualizarPagina']) {
                ?>
                <div class="p-2">
                    <a href="<?php echo URLADM . 'VerPagina/verPagina/' . $valorFormulario['id']; ?>" class="btn btn-outline-primary btn-sm">Visualizar</a>
                </div>
                <?php
            }
            ?>
        ...
        <form method="POST" action="" enctype="multipart/form-data"> 
            ...
            <input name="EditarPagina" type="submit" class="btn btn-warning" value="Salvar">
        </form>
    </div>
</div>
