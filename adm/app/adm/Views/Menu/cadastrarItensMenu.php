...
<div class="content p-1">
    <div class="list-group-item">
        <div class="d-flex">
            ...
            <?php
            if ($this->Dados['botao']['ListarItensMenu']) {
                ?>
                <div class="p-2">
                    <a href="<?php echo URLADM . 'Menu/listar'; ?>" class="btn btn-outline-primary btn-sm">Listar</a>
                </div>
                <?php
            }
            ?>
        ...
        <form method="POST" action="" enctype="multipart/form-data"> 
            ...
            <input name="CadastrarItensMenu" type="submit" class="btn btn-warning" value="Salvar">
        </form>
    </div>
</div>
