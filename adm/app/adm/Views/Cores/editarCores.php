    ...
    <div class="list-group-item">
        <div class="d-flex">
            <div class="mr-auto p-2">
                <h2 class="display-4 titulo">Editar Cores</h2>
            </div>
            ...
            if ($this->Dados['botao']['VisualizarCores']) {
                ?>
                <div class="p-2">
                    <a href="<?php echo URLADM . 'VerCores/VerCores/' . $valorFormulario['id']; ?>" class="btn btn-outline-primary btn-sm">Visualizar</a>
                </div>
                <?php
            }
            ?>
        ...
        <form method="POST" action="" enctype="multipart/form-data"> 
            ...
            <input name="EditarCores" type="submit" class="btn btn-warning" value="Salvar">
        </form>
    </div>
</div>
