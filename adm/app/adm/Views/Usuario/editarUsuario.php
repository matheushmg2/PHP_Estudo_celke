...
<div class="content p-1">
    <div class="list-group-item">
            ...
            <div class="p-2">
                <?php 
                    if($this->Dados['botao']['VisualizarUsuario']) {
                        echo " <a href=" . URLADM . 'VerUsuario/verUsuario/'.$valorFormulario['id'] ." class='btn btn-outline-primary btn-sm'>Visualizar</a>";
                    }
                ?>
            </div>
        </div>
        ...
        <form method="POST" action="" enctype="multipart/form-data">
            <!-- Para trabalhar com Tipo Imagem é necessário ultilizar no FORM o sequinte  |enctype="multipart/form-data"| para que não ocorra erro -->
            <input name="id" type="hidden" value="<?php if(isset($valorFormulario['id'])) {echo $valorFormulario['id'];}  ?>">
            <div class="form-row">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    <input name="imagem_antiga" type="hidden" value="<?php if (isset($valorFormulario['imagem_antiga'])) { echo $valorFormulario['imagem_antiga']; } // Se existir uma imagem atribua a própria
                ...
                <div class="form-group col-md-6">
                    ...
                    if (isset($valorFormulario['imagem']) && !empty($valorFormulario['imagem'])) {
                        $imagem_antiga = URLADM . 'assets/image/usuarios/' . $valorFormulario['id'] . '/' . $valorFormulario['imagem'];
                    } elseif (isset($valorFormulario['imagem_antiga']) && !empty($valorFormulario['imagem_antiga'])) {
                        $imagem_antiga = URLADM . 'assets/image/usuarios/' . $valorFormulario['id'] . '/' . $valorFormulario['imagem_antiga'];
                    }
                     else {
            ...
            <input type="submit" name="EditarUsuario" class="btn btn-info" value="Salvar">
        </form>
    </div>
</div>