...
if (!empty($this->Dados['verGrupoPagina'][0])) {
    extract($this->Dados['verGrupoPagina'][0]);
    ?>
                ...
                <div class="p-2">
                    <span class="d-none d-md-block">
                        ...
                        if ($this->Dados['botao']['ListarGrupoPagina']) {
                            echo "<a href='" . URLADM . "GrupoPagina/listar' class='btn btn-outline-info btn-sm'>Listar</a> ";
                        }
    ...
    $UrlDestino = URLADM . 'Grupo/listar';
