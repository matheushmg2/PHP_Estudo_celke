...
class ConfigController
{
    ...
    {
        $listarPg = new \App\adm\Models\AdmPaginas();
        ...
        if($this->Paginas){
            ...
            if(class_exists($this->Classe)){
                ...
                $this->carregarControllersEMetodosPrimario(CONTROLLER, METODO);
            }
        }else {
            $this->carregarControllersEMetodosPrimario('Login', 'acesso');
        }
    }
    ...
    private function carregarControllersEMetodosPrimario($controller, $metodo){
        $this->UrlController = $this->slugController($controller);
        $this->UrlMetodo = $this->slugController($metodo);
        $this->carregar();
    }
